            ...
            {isLoading ? (
              ...
              authorPayouts.map((item, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-right">{item.totalArticles}</TableCell>
                  <TableCell className="text-right">${item.newsPayout.toFixed(2)}</TableCell>
                  <TableCell className="text-right">${item.blogPayout.toFixed(2)}</TableCell>
                  <TableCell className="text-right font-bold">${item.totalPayout.toFixed(2)}</TableCell>
                </TableRow>
              ))
            )}
          </TableBody>
